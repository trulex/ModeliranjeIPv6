...
Miha Novak, 63099999\\
Gregor Bahor, 63099999\\
Darko Janković6, 63100176\\
...
\section{Opišite vsaj 3 zglede za modeliranje IPv6 omrežij v INET ogrodju.}
...
\subsection{IPv6Bulk}
Omrežje sestavljajo strežnik, usmerjevalnik in trije odjemalci. Strežnik in vsi trije odjemalci so povezani z usmerjevalnikom, obstaja pa tudi direktna povezava med strežnikom in enimi izmed odjemalcem. Vse povezave so tipa in/out, hitrost prenosa podatkov po kanalu pa je 10Mbps z zakasnitvijo 0.1us. Ves promet v omrežju usmerja usmerjevalnik, ki usmerja tudi promet med strežnikom in odjemalcem. Pred zagonom simulacije lahko izberamo med različnimi TCP implementacijami (TCP, TCP\_lwIP, TCP\_NSC). Po omrežju se prenašajo različni paketi. Neighbor Discovery Protocol (NDP) - RApacket (router advertisement), RSpacket (Router Solicitatio) NAPacket (Neighbour Advertisement) in NAPacket (Neighbour Solicitation) potem sledi rokovanje (ACK)... TODO.
...
- configurator tipa FlatNetworkConfigurator6
- r1 tipa Router6
- r2 tipa Router6
- cli[n] tipa StandardHost6
- srv[n] tipa StandardHost6
- linemonitor[n] tipa TCPDump
